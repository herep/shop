<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:66:"D:\www\pygshop\public/../application/admin\view\manager\login.html";i:1544360135;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
    ...
    <div id="loginform" class="loginBox">
        ...
        <form class="form form-horizontal" action="<?php echo \think\Request::instance()->url(); ?>" method="post">
            ...
            <div class="row cl">
                <label class="form-label col-xs-3"><i class="Hui-iconfont">&#xe60e;</i></label>
                <div class="formControls col-xs-8">
                    <input id="" name="mg_pwd" type="password" placeholder="密码" class="input-text size-L">
                </div>
            </div>
            <div class="row cl">
                <div class="formControls col-xs-8 col-xs-offset-3">
                    <input class="input-text size-L"
                    ...
                    <img src="<?php echo captcha_src(); ?>" alt="验证码" width="145" height="40"
                        onclick="this.src=this.src+'?'+Math.random()"
                    />
                    <img src=""> <a id="kanbuq" href="javascript:;"></a> </div>
            </div>
            <div class="row cl">
                <div class="formControls col-xs-8 col-xs-offset-3">
                    <label for="online">
