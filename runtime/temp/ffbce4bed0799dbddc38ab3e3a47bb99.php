<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:62:"D:\www\pygshop\public/../application/home\view\user\login.html";i:1544162415;}*/ ?>
<!DOCTYPE html>
<html>
                ...
                <div class="tab-content tab-wraped">
                    ...
                    <div id="profile" class="tab-pane  active">
                        <form class="sui-form" method="post" action="<?php echo \think\Request::instance()->url(); ?>">
                            <div class="input-prepend"><span class="add-on loginname"></span>
                                <input  type="text"
                                        ...
                                        class="span2 input-xfat"
                                         value="<?php echo (isset($shuju['username'] ) && ($shuju['username']  !== '')?$shuju['username'] :''); ?>"
                                >
                            </div>
                            ...
                            <span style="color: red"><?php echo (isset($errorinfo) && ($errorinfo !== '')?$errorinfo:''); ?></span>
                            <div class="setting">
                            ...
                            <div class="logined">
                                <input type="submit" class = "sui-btn btn-block btn-xlarge btn-danger" href="home.html" target="_blank" value="登录"/>
                            </div>
                        </form>
                        <div class="otherlogin">
                            <div class="types">
                                <ul>
                                    <li><img src="<?php echo config('home_img'); ?>qq.png" width="35px" height="35px" /></li>
