<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:63:"D:\www\pygshop\public/../application/home\view\index\index.html";i:1545214643;s:53:"D:\www\pygshop\application\home\view\public\head.html";i:1545208021;s:53:"D:\www\pygshop\application\home\view\public\foot.html";i:1543911250;}*/ ?>
<!DOCTYPE html>
<html>
...
<link rel="stylesheet" type="text/css" href="<?php echo config('home_css'); ?>pages-JD-index.css" />
<!--列表-->
<div class="py-container">
                ...
                <div class="carousel-inner">
                    <div class="active item">
                        <a href="http://baidu2.wypxj.com/">
                            <img src="<?php echo config('home_img'); ?>banner1.jpg"  />
                        </a>
                    </div>
                    <div class="item">
                        <a href="http://baidu2.wypxj.com/">
                            <img src="<?php echo config('home_img'); ?>banner2.jpg"  />
                        </a>
                    </div>
                    <div class="item">
                        <a href="http://baidu2.wypxj.com/">
                            <img src="<?php echo config('home_img'); ?>banner3.jpg"  />
                        </a>
    ...
    <div class="py-container">
        <ul class="yui3-g Recommend">
            <li class="yui3-u-1-6  clock">
                <div class="time">
                    <img src="<?php echo config('home_img'); ?>clock.png" />
                    <h3>今日推荐</h3>
                </div>
            </li>
            <li class="yui3-u-5-24">
                <a href="list.html" target="_blank"><img src="<?php echo config('home_img'); ?>today01.png" /></a>
            </li>
            <li class="yui3-u-5-24">
                <img src="<?php echo config('home_img'); ?>today02.png" />
            </li>
            <li class="yui3-u-5-24">
                <img src="<?php echo config('home_img'); ?>today03.png" />
            </li>
            <li class="yui3-u-5-24">
                <img src="<?php echo config('home_img'); ?>today04.png" />
            </li>
        </ul>
    </div>
</div>
    ...
    <div class="content">
        <ul>
            <li style="display:block;">
                <?php if(is_array($hostsalenum) || $hostsalenum instanceof \think\Collection || $hostsalenum instanceof \think\Paginator): $i = 0; $__LIST__ = $hostsalenum;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>
                <div class="img-item">
                    <p class="tab-pic">
                        <span><a href="#"><img src="<?php echo substr($v['goods_logo'],1); ?>"/></a></span>
                    </p>
                    <div class="tab-info">
                        <div class="info-title">
                            <span><a href="#"><?php echo $v['goods_introduce']; ?></a></span>
                        </div>
                        <p class="info-price">定金：¥<?php echo $v['goods_price']; ?></p>
                    </div>
                </div>
               <?php endforeach; endif; else: echo "" ;endif; ?>
            </li>
            <li>
               <?php if(is_array($is_pro) || $is_pro instanceof \think\Collection || $is_pro instanceof \think\Paginator): $i = 0; $__LIST__ = $is_pro;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>
                <div class="img-item">
                    <p class="tab-pic">
                        <span><a href="#"><img src="<?php echo substr($v['goods_logo'],1); ?>"/></a></span>
                    </p>
            ...
            <ul class="clearfix yui3-g Favourate picLB" id="picLBxxl">
                <li class="yui3-u-1-6">
                    <dl class="picDl huozhe">
                        <dd>
                            <a href="" class="pic"><img src="<?php echo config('home_img'); ?>like_02.png" alt="" /></a>
                            <div class="like-text">
                        ...
                        <dd>
                            <a href="" class="pic"><img src="<?php echo config('home_img'); ?>like_01.png" alt="" /></a>
                            <div class="like-text">
                ...
                <li class="yui3-u-1-6">
                    <dl class="picDl jilu">
                        <dd>
                            <a href="" class="pic"><img src="<?php echo config('home_img'); ?>like_03.png" alt="" /></a>
                            <div class="like-text">
                                <p>爱仕达 30CM炒锅不粘锅NWG8330E电磁炉炒</p>
                                <h3>¥116.00</h3>
                            </div>
                ...
                <li class="yui3-u-1-6">
                    <dl class="picDl jilu">
                        <dd>
                            <a href="http://sc.chinaz.com/" class="pic"><img src="<?php echo config('home_img'); ?>like_03.png" alt="" /></a>
                            <div class="like-text">
                                <p>捷波朗 </p>
                                <p>（jabra）BOOSI劲步</p>
                                <h3>¥236.00</h3>
                        ...
                        <dd>
                            <a href="http://sc.chinaz.com/" class="pic"><img src="<?php echo config('home_img'); ?>like_02.png" alt="" /></a>
                            <div class="like-text">
                                <p>欧普</p>
                                <p>JYLZ08面板灯平板灯铝</p>
                                <h3>¥456.00</h3>
                ...
                <li class="yui3-u-1-6">
                    <dl class="picDl tuhua">
                        <dd>
                            <a href="http://sc.chinaz.com/" class="pic"><img src="<?php echo config('home_img'); ?>like_01.png" alt="" /></a>
                            <div class="like-text">
                                <p>三星（G5500）</p>
                                <p>移动联通双网通</p>
                                <h3>¥566.00</h3>
    ...
    <div class="py-container">
        ...
        <div class="clearfix yui3-g Interest">
            ...
            <div class="yui3-u row-405 Interest-conver">
                <img src="<?php echo config('home_img'); ?>interest01.png" />
            </div>
            <div class="yui3-u row-225 Interest-conver-split">
                <h5>好东西</h5>
                <img src="<?php echo config('home_img'); ?>interest02.png" />
                <img src="<?php echo config('home_img'); ?>interest03.png" />
            </div>
            <div class="yui3-u row-405 Interest-conver-split blockgary">
                <h5>品牌街</h5>
                <div class="split-bt">
                    <img src="<?php echo config('home_img'); ?>interest04.png" />
                </div>
                <div class="x-img fl">
                    <img src="<?php echo config('home_img'); ?>interest05.png" />
                </div>
                <div class="x-img fr">
                    <img src="<?php echo config('home_img'); ?>interest06.png" />
                </div>
            </div>
            <div class="yui3-u row-165 brandArea">
                <span class="brand-yline"></span>
                <ul class="yui3-g brand-list">
                    <li class="yui3-u-1-2 brand-pit"><img src="<?php echo config('home_img'); ?>brand01.png" /></li>
                    <li class="yui3-u-1-2 brand-pit"><img src="<?php echo config('home_img'); ?>brand02.png" /></li>
                    <li class="yui3-u-1-2 brand-pit"><img src="<?php echo config('home_img'); ?>brand03.png" /></li>
                    <li class="yui3-u-1-2 brand-pit"><img src="<?php echo config('home_img'); ?>brand04.png" /></li>
                    <li class="yui3-u-1-2 brand-pit"><img src="<?php echo config('home_img'); ?>brand05.png" /></li>
                    <li class="yui3-u-1-2 brand-pit"><img src="<?php echo config('home_img'); ?>brand06.png" /></li>
                    <li class="yui3-u-1-2 brand-pit"><img src="<?php echo config('home_img'); ?>brand07.png" /></li>
                    <li class="yui3-u-1-2 brand-pit"><img src="<?php echo config('home_img'); ?>brand08.png" /></li>
                    <li class="yui3-u-1-2 brand-pit"><img src="<?php echo config('home_img'); ?>brand09.png" /></li>
                    <li class="yui3-u-1-2 brand-pit"><img src="<?php echo config('home_img'); ?>brand10.png" /></li>
                    <li class="yui3-u-1-2 brand-pit"><img src="<?php echo config('home_img'); ?>brand11.png" /></li>
                    <li class="yui3-u-1-2 brand-pit"><img src="<?php echo config('home_img'); ?>brand12.png" /></li>
                    <li class="yui3-u-1-2 brand-pit"><img src="<?php echo config('home_img'); ?>brand13.png" /></li>
                    <li class="yui3-u-1-2 brand-pit"><img src="<?php echo config('home_img'); ?>brand03.png" /></li>
                </ul>
            </div>
        </div>
            ...
            <div id="tab1" class="tab-pane active">
                <div class="yui3-g Floor-1">
                    <div class="yui3-u Left blockgary">
                        ...
                        <img src="<?php echo config('home_img'); ?>floor-1-1.png" />
                    </div>
                    <div class="yui3-u row-330 floorBanner">
                        <div id="floorCarousel" data-ride="carousel" data-interval="4000" class="sui-carousel slide">
                            ...
                            <div class="carousel-inner">
                                <div class="active item">
                                    <img src="<?php echo config('home_img'); ?>floor-1-b01.png">
                                </div>
                                <div class="item">
                                    <img src="<?php echo config('home_img'); ?>floor-1-b02.png">
                                </div>
                                <div class="item">
                                    <img src="<?php echo config('home_img'); ?>floor-1-b03.png">
                                </div>
                            </div>
                    ...
                    <div class="yui3-u row-220 split">
                        ...
                        <div class="floor-conver-pit">
                            <img src="<?php echo config('home_img'); ?>floor-1-2.png" />
                        </div>
                        <div class="floor-conver-pit">
                            <img src="<?php echo config('home_img'); ?>floor-1-3.png" />
                        </div>
                    </div>
                    <div class="yui3-u row-218 split">
                        <img src="<?php echo config('home_img'); ?>floor-1-4.png" />
                    </div>
                    <div class="yui3-u row-220 split">
                        <span class="floor-x-line"></span>
                        <div class="floor-conver-pit">
                            <img src="<?php echo config('home_img'); ?>floor-1-5.png" />
                        </div>
                        <div class="floor-conver-pit">
                            <img src="<?php echo config('home_img'); ?>floor-1-6.png" />
                        </div>
                    </div>
                </div>
            </div>
...
<div class="brand">
    <div class="py-container">
        <ul class="Brand-list blockgary">
            <li class="Brand-item">
                <img src="<?php echo config('home_img'); ?>brand_21.png" />
            </li>
            <li class="Brand-item"><img src="<?php echo config('home_img'); ?>brand_03.png" /></li>
            <li class="Brand-item"><img src="<?php echo config('home_img'); ?>brand_05.png" /></li>
            <li class="Brand-item"><img src="<?php echo config('home_img'); ?>brand_07.png" /></li>
            <li class="Brand-item"><img src="<?php echo config('home_img'); ?>brand_09.png" /></li>
            <li class="Brand-item"><img src="<?php echo config('home_img'); ?>brand_11.png" /></li>
            <li class="Brand-item"><img src="<?php echo config('home_img'); ?>brand_13.png" /></li>
            <li class="Brand-item"><img src="<?php echo config('home_img'); ?>brand_15.png" /></li>
            <li class="Brand-item"><img src="<?php echo config('home_img'); ?>brand_17.png" /></li>
            <li class="Brand-item"><img src="<?php echo config('home_img'); ?>brand_19.png" /></li>
        </ul>
    </div>
</div>
<!--页面底部-->
