<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:67:"D:\www\pygshop\public/../application/home\view\shop\return_url.html";i:1544274097;s:54:"D:\www\pygshop\application\home\view\public\head2.html";i:1544236267;}*/ ?>
<!DOCTYPE html>
<html>
...
<title>支付页-成功</title>
<link rel="stylesheet" type="text/css" href="<?php echo config('home_css'); ?>/pages-paysuccess.css" />
<div class="cart py-container">
    ...
    <div class="paysuccess">
        <div class="success">
            <h3><img src="<?php echo config('home_img'); ?>/_/right.png" width="48" height="48">　恭喜您，支付成功啦！</h3>
            <div class="paydetail">
                <p>订单编号：<?php echo $out_trade_no; ?></p>
                <p>支付方式：支付宝</p>
                <p>支付金额：￥<?php echo $total_amout; ?>元</p>
