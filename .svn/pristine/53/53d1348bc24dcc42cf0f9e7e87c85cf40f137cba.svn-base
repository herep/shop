<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:63:"D:\www\pygshop\public/../application/home\view\goods\index.html";i:1543922525;s:53:"D:\www\pygshop\application\home\view\public\head.html";i:1545208021;s:53:"D:\www\pygshop\application\home\view\public\foot.html";i:1543911250;}*/ ?>
<!DOCTYPE html>
<html>
...
<title>产品列表页</title>
<link rel="stylesheet" type="text/css" href="<?php echo config('home_css'); ?>pages-list.css" />
        ...
        <div class="clearfix selector">
            ...
            <div class="type-wrap logo">
                ...
                <div class="value logos">
                    <ul class="logo-list">
                        <li><img src="<?php echo config('home_img'); ?>_/phone01.png" /></li>
                        <li><img src="<?php echo config('home_img'); ?>_/phone02.png" /></li>
                        <li><img src="<?php echo config('home_img'); ?>_/phone03.png" /></li>
                        <li><img src="<?php echo config('home_img'); ?>_/phone04.png" /></li>
                        <li><img src="<?php echo config('home_img'); ?>_/phone05.png" /></li>
                        <li><img src="<?php echo config('home_img'); ?>_/phone06.png" /></li>
                        <li><img src="<?php echo config('home_img'); ?>_/phone07.png" /></li>
                        <li><img src="<?php echo config('home_img'); ?>_/phone08.png" /></li>
                        <li><img src="<?php echo config('home_img'); ?>_/phone09.png" /></li>
                        <li><img src="<?php echo config('home_img'); ?>_/phone10.png" /></li>
                        <li><img src="<?php echo config('home_img'); ?>_/phone11.png" /></li>
                        <li><img src="<?php echo config('home_img'); ?>_/phone12.png" /></li>
                        <li><img src="<?php echo config('home_img'); ?>_/phone13.png" /></li>
                        <li><img src="<?php echo config('home_img'); ?>_/phone14.png" /></li>
                        <li><img src="<?php echo config('home_img'); ?>_/phone05.png" /></li>
                        <li><img src="<?php echo config('home_img'); ?>_/phone06.png" /></li>
                        <li><img src="<?php echo config('home_img'); ?>_/phone07.png" /></li>
                        <li><img src="<?php echo config('home_img'); ?>_/phone02.png" /></li>
                        ...
                        <div class="list-wrap">
                            <div class="p-img">
                                <a href="<?php echo url('goods/detail',['goods_id'=>$v['goods_id']]); ?>" target="_blank">
                                    <img src="<?php echo substr($v['goods_logo'],1); ?>" /></a>
                            </div>
                            <div class="price">
                                <strong>
                                    <em>¥</em>
            ...
            <div class="hot-list">
                <ul class="yui3-g">
                    <li class="yui3-u-1-4">
                        <div class="list-wrap">
                            <div class="p-img">
                                <img src="<?php echo config('home_img'); ?>like_01.png" />
                            </div>
                            <div class="attr">
                    ...
                    <li class="yui3-u-1-4">
                        <div class="list-wrap">
                            <div class="p-img">
                                <img src="<?php echo config('home_img'); ?>like_03.png" />
                            </div>
                            <div class="attr">
                    ...
                    <li class="yui3-u-1-4">
                        <div class="list-wrap">
                            <div class="p-img">
                                <img src="<?php echo config('home_img'); ?>like_04.png" />
                            </div>
                            <div class="attr">
                    ...
                    <li class="yui3-u-1-4">
                        <div class="list-wrap">
                            <div class="p-img">
                                <img src="<?php echo config('home_img'); ?>like_02.png" />
                            </div>
                            <div class="attr">
                                <em>Apple苹果iPhone 6s (A1699)</em>
                            </div>
